package com.ericwyn.seafile;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.parser.Feature;
import com.ericwyn.seafile.Interface.ApiInterface;
import com.ericwyn.seafile.jsonObject.DirectoryEntry;
import com.ericwyn.seafile.jsonObject.FileCommit;
import com.ericwyn.seafile.jsonObject.FileDetail;
import com.ericwyn.seafile.jsonObject.Library;
import com.ericwyn.seafile.jsonObject.LibraryHistory;
import com.ericwyn.seafile.jsonObject.StarredFile;
import com.ericwyn.seafile.jsonObject.UploadFileRes;
...
public class SeafileApi implements ApiInterface {
    ...
    public void checkAccountInfo(OkHttpClient client,String token,Callback callback) {
        Request request=new Request.Builder()
                .header("Content-Type","application/x-www-form-urlencoded")
                .header("Authorization","Token "+token)
                .header("Accept","application/json")
